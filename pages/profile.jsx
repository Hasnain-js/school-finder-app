		...
		<>
			<section className=''>
				...
				<div className='flex items-start justify-start gap-5'>
					<aside class='flex flex-col pl-10 max-w-sm w-full h-screen px-4 pb-8  bg-transparent'>
						<div class='flex flex-col items-start gap-1 -mt-12'>
							...
							<p class='text-sm font-medium text-LightGreyText'>
						...
						<div className='grid grid-cols-2 grid-rows-2 border gap-y-4 p-5 mt-4 border-romance rounded-lg'>
							<div className='border-b border-romance pb-4'>
								...
								<p class='text-sm font-medium text-LightGreyText'>Followers</p>
							</div>
							<div className='border-b border-romance pb-4'>
								<h4 class='font-medium text-gray-800 dark:text-gray-200'>
									3.6k
								</h4>
								<p class='text-sm font-medium text-LightGreyText'>Post</p>
							</div>
							<div>
								<h4 class='font-medium text-gray-800 dark:text-gray-200'>
									3.8k
								</h4>
								<p class='text-sm font-medium text-LightGreyText'>Collection</p>
							</div>
							<div>
								<h4 class='font-medium text-gray-800 dark:text-gray-200'>
									4.1k
					...
					<aside className='mt-12 w-full'>
						{/* Tabs buttons */}
						<div class='flex items-end justify-between overflow-x-auto overflow-y-hidden border-b-2 border-b-romance whitespace-nowrap dark:border-gray-700'>
							<div className='flex'>
								<button

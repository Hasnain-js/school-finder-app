...
export default function OurSchool() {
  return (
    <div>
      ...
      <section>
        <HeroicSection>
          <div className="max-w-7xl px-6 mx-auto flex flex-col items-center gap-12">
            <h1 className="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
              Our Schools
            </h1>
            {/* Search functionality */}
            <form className="relative max-w-3xl flex items-center justify-between shadow-2xl shadow-silverGrey w-full p-2 text-sm text-black rounded-2xl bg-white overflow-hidden">
              <div className="flex w-full items-center gap-3">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="bg-transparent w-full lg:text-2xl text-lg outline-none flex-grow"
              ...
              <button
                type="submit"
                className="text-white bg-rustyRed w-fit hover:bg-blueStone focus:ring-4 focus:outline-none  font-medium rounded-2xl flex-shrink-0 text-lg lg:px-9 px-4 lg:py-4 py-2"
              >
                Search
              </button>
            </form>

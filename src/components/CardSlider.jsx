...
const CardSlider = () => {
    ...
    const next = () => {
        ...
        getTracks.value = getTracks.value.concat(first);

    }
	return (
		<>
			<div className='relative flex items-center justify-center'>
				<button className='bg-black text-white'>previous</button>
                {
				...
				<div className='grid-cols-3'>
					<div className='w-28 h-36 rounded bg-gray-500 flex items-center justify-center'>
						card
					</div>
					<div className='w-28 h-36 rounded bg-gray-500 flex items-center justify-center'>
						card
